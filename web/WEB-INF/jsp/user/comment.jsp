        ...
        <form action="/comments/add" onsubmit="submit_sure()" method="post">
            ...
            <div class="single-feature mb-35" style="width: 60%;margin: 0 auto;min-width: 500px">
                <div class="p_photo" style=" width: 30%;float: left;margin-left: 5%">
                    <div id="result" style="height: 200px;width: 200px"><img style="width: 150px;height: 150px"
                                                                             src="../../${product.picPath.get(0)}">
                    </div>
                </div>
                <div class="customer_info" style="width:70%;float: left; text-align: center">
                    <h4><strong>商品名称：</strong>${product.productName}</h4>
                    <h4>你的评价</h4>
                    <div id="starRating" style="margin-top: 30px">
                        <p class="starRating">
                    ...
                    <div style="margin-top: 30px">
                        <textarea type="t" id="comment-content" value="" name="content"
                                  placeholder="请填写评价内容">${comment.ccontent}</textarea>
                    </div>
                    <br/><br/>
                    <button type="submit" class="form-button" value="comment_product" style="margin-left: 45%">提交评价
                    </button>
                </div>
            </div>
        </form>
