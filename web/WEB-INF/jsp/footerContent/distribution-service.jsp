...
<div class="wrapper">
    ...
    <!--Header Area End-->
        <div class="distribution-container" style="width: 60%;margin:10% auto">
            <div class="distribution-title">
                <h1 style="text-align: center">商品配送</h1>
            </div>
            <br/>
            <div class="distribution-content">
                <ul>
                    <p style="text-align: center;line-height:40px;font-size:large">
                        本平台不支持商品配送，请消费者和文化团队私下解决送货问题。<br/>
                        谢谢合作！
                    </p>
                </ul>
            </div>
